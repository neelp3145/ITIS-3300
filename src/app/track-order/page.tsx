...
export default function TrackOrder() {
  ...
  const calculateRemainingTime = (createdAt: string, estimatedPrepTime: number) => {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '600px', margin: '0 auto', minHeight: '50vh' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
            ...
            <div style={{
              ...
              ⏱️ {calculateRemainingTime(order.createdAt, order.estimatedPrepTime)}m remaining
            </div>
          </div>

          <div style={{ marginBottom: '1rem' }}>
            <h3 style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>Items:</h3>
